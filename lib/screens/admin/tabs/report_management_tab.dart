...
class _ReportManagementTabState extends State<ReportManagementTab>
  ...
  // ------------------------------------------
  // FITUR REFRESH: reload stream dengan setState
  // ------------------------------------------
  ...
  // ============================================================================
  // STREAM BUILDER + REFRESH INDICATOR (FITUR BARU DITAMBAHKAN DI SINI)
  // ============================================================================
  Widget _buildReportList(String status) {
    return RefreshIndicator(
      onRefresh: _refreshData, // <-- FITUR REFRESH DITAMBAHKAN DI SINI
    ...
    switch (status) {
      ...
      case 'Selesai':
        return {
          ...
          'bgColor': AppColors.statusDone.withOpacity(0.1)
        };
      case 'Ditolak':
        return {
